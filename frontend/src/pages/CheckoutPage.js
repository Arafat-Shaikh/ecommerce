...
const { handleQuantity, handleDeleteCartItem } = Cart;
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                      <div className="sm:col-span-4">
                        ...
                        <div className="mt-2">
                          ...
                          <p className="text-red-500">error message here</p>
                        </div>
                      </div>
            ...
            <div className="border-b border-gray-900/10 pb-12 ">
              <ul>
                <li className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-900 rounded-lg">
                  ...
                  <div className="hidden sm:flex sm:flex-col sm:items-end">
                    ...
                    <p className="text-sm leading-6 text-gray-500">city</p>
                  </div>
                </li>
              </ul>
